...
void MX_LCD_Init(void)
{
  ...
  /* USER CODE END SPI1_Init 1 */
	...
	lcdSpi.Init.DataSize = SPI_DATASIZE_8BIT; // SPI_DATASIZE_8BIT
	lcdSpi.Init.CLKPolarity = SPI_POLARITY_LOW;
	lcdSpi.Init.CLKPhase = SPI_PHASE_1EDGE;
	lcdSpi.Init.NSS = SPI_NSS_SOFT;
	lcdSpi.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_16;
	...
	lcdSpi.Init.CRCLength = SPI_CRC_LENGTH_DATASIZE;
	lcdSpi.Init.NSSPMode = SPI_NSS_PULSE_DISABLE;
